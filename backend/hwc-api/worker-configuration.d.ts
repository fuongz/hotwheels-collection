/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 08a50eecd3b6cad97dbdce3be22d0bbe)
// Runtime types generated with workerd@1.20251210.0 2025-12-17 nodejs_compat
declare namespace Cloudflare {
	...
	interface Env {
		...
		BETTER_AUTH_REDIRECT_URI: string;
		BUCKET: R2Bucket;
		DB: D1Database;
		BETTER_AUTH_SECRET: SecretsStoreSecret;
		GOOGLE_CLIENT_ID: SecretsStoreSecret;
		GOOGLE_CLIENT_SECRET: SecretsStoreSecret;
		CLOUDINARY_API_KEY: SecretsStoreSecret;
		CLOUDINARY_API_SECRET: SecretsStoreSecret;
		CLOUDINARY_CLOUD_NAME: SecretsStoreSecret;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "FRONTEND_URL" | "BETTER_AUTH_URL" | "BETTER_AUTH_REDIRECT_URI">> {}
}
